...
with open('../result/Tfisher_dict0.pickle', 'r') as f:
...
np.save("../result/tX_class.npy", X)
np.save("../result/ty_class.npy", y)


z = np.loadtxt("../result/Tfisher_group0.txt")
